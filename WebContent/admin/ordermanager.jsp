...
<table  style="margin: 0 auto;">
		<tr><td colspan=6 style="text-align: center;  font-size:15px"><b>주문 목록</b></td></tr>
		...
		if(list.size() == 0){
			%>
				<tr><td colspan=6 style="text-align:center">주문내역이 없습니다.</td></tr>
			<%
		}else{
			...
			<tr>
				...
				<th  style="width:80px; height:40px; font-size:14px; text-align: center;">보기</th>
			</tr>
				...
				%>
					<tr>
						<td style="text-align: left;">
							<label style="width:80px; height:40px; font-size:14px"><%=product.getNo() %></label>
						</td>
						<td style="text-align: left;">
					...
					<td style="text-align:center;">
						<label style="width:80px; height:40px; font-size:14px;"><a href="javascript:orderDetail('<%=order.getNo()%>')">상세보기</a></label>
					</td>
					</tr>
			<%		
			}
